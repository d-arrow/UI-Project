...
namespace SingleplayerLauncher.Resources
{
	internal static class Loadout
	{
		public class Trap
		{
			...
			public static readonly Trap FloorSpikes = new Trap()
			{
				Name = "Floor Spikes",
			...
			public static readonly Trap ArcaneBowlingBall = new Trap()
			{
			...
			public static readonly Trap ArcanePhaser = new Trap()
			{
				Name = "Arcane Phaser",
			...
			public static readonly Trap ArrowWall = new Trap()
			{
				Name = "Arrow Wall",
			...
			public static readonly Trap BGHArrowWall = new Trap()
			{
				Name = "BGH Arrow Wall",
			...
			public static readonly Trap CeilingBallista = new Trap()
			{
			...
			public static readonly Trap DragonsLance = new Trap()
			{
				Name = "Dragons Lance",
			...
			public static readonly Trap BGHCeilingBallista = new Trap()
			{
			...
			public static readonly Trap Barricade = new Trap()
			{
				Name = "Barricade",
			...
			public static readonly Trap GreatWallBarricade = new Trap()
			{
			...
			public static readonly Trap BoomBarrel = new Trap()
			{
				Name = "Boom Barrel",
			...
			public static readonly Trap BoomBarrelRoller = new Trap()
			{
			...
			public static readonly Trap BoulderChute = new Trap()
			{
				Name = "Boulder Chute",
			...
			public static readonly Trap IcicleImpaler = new Trap()
			{
				Name = "Icicle Impaler",
			...
			public static readonly Trap Brimstone = new Trap()
			{
				Name = "Brimstone",
			...
			public static readonly Trap CoinForge = new Trap()
			{
				Name = "Coin Forge",
			...
			public static readonly Trap CursedGround = new Trap()
			{
				Name = "Cursed Ground",
			...
			public static readonly Trap Decoy = new Trap()
			{
				Name = "Decoy",
			...
			public static readonly Trap SpitfireWall = new Trap()
			{
				Name = "Spitfire Wall",
			...
			public static readonly Trap FireCracker = new Trap()
			{
				Name = "Fire Cracker",
			...
			public static readonly Trap FlipTrap = new Trap()
			{
				Name = "Flip Trap",
			...
			public static readonly Trap FloorScorcher = new Trap()
			{
				Name = "Floor Scorcher",
			...
			public static readonly Trap TempleAlarmGong = new Trap()
			{
			...
			public static readonly Trap Grinder = new Trap()
			{
				Name = "Grinder",
			...
			public static readonly Trap QuarterPounder = new Trap()
			{
			...
			public static readonly Trap Haymaker = new Trap()
			{
				Name = "Haymaker",
			...
			public static readonly Trap HealingWell = new Trap()
			{
				Name = "Healing Well",
			...
			public static readonly Trap IceShard = new Trap()
			{
				Name = "Ice Shard",
			...
			public static readonly Trap IceVent = new Trap()
			{
				Name = "Ice Vent",
			...
			public static readonly Trap LightningRod = new Trap()
			{
				Name = "Lightning Rod",
			...
			public static readonly Trap ManaWell = new Trap()
			{
				Name = "Mana Well",
			...
			public static readonly Trap SummonerTrap = new Trap()
			{
				Name = "Summoner Trap",
			...
			public static readonly Trap NaphthaSprayer = new Trap()
			{
			...
			public static readonly Trap OverloadTrap = new Trap()
			{
				Name = "Overload Trap",
			...
			public static readonly Trap PowerupDamage = new Trap()
			{
				Name = "Powerup Damage",
			...
			public static readonly Trap Pounder = new Trap()
			{
				Name = "Pounder",
			...
			public static readonly Trap ConcussivePounder = new Trap()
			{
			...
			public static readonly Trap PowerGenerator = new Trap()
			{
			...
			public static readonly Trap PushTrap = new Trap()
			{
				Name = "Push Trap",
			...
			public static readonly Trap SawOfArctos = new Trap()
			{
				Name = "Saw Of Arctos",
			...
			public static readonly Trap ShieldPowerup = new Trap()
			{
				Name = "Shield Powerup",
			...
			public static readonly Trap SpeedPad = new Trap()
			{
				Name = "Speed Pad",
			...
			public static readonly Trap SpikeWall = new Trap()
			{
				Name = "Spike Wall",
			...
			public static readonly Trap SteamVent = new Trap()
			{
				Name = "Steam Vent",
			...
			public static readonly Trap SwingingMace = new Trap()
			{
				Name = "Swinging Mace",
			...
			public static readonly Trap TarTrap = new Trap()
			{
				Name = "Tar Trap",
			...
			public static readonly Trap ViscousTar = new Trap()
			{
				Name = "Viscous Tar",
			...
			public static readonly Trap ShockZapper = new Trap()
			{
				Name = "Shock Zapper",
			...
			public static readonly Trap BGHShockZapper = new Trap()
			{
				Name = "BGH Zapper",
			...
			public static readonly Trap TripWire = new Trap()
			{
				Name = "Trip Wire",
			...
			public static readonly Trap WallBlades = new Trap()
			{
				Name = "Wall Blades",
			...
			public static readonly Trap WallCharger = new Trap()
			{
				Name = "Wall Charger",
			...
			public static readonly Trap WebSpinner = new Trap()
			{
				Name = "Web Spinner",
		...
		#region Traps (Name, Hex)
		// Hex representation in SpitfireGame.upk
		public static readonly Dictionary<string, Trap> Traps = new Dictionary<string, Trap>
		{
            //{ "Acid Sprayer", null },
		...
		public static readonly List<byte[]> TrapTextureIds = new List<byte[]>()
		{
			new byte[] { 0x31 }, new byte[] { 0x32 },
								 new byte[] { 0x32 }, new byte[] { 0x33 },
													  new byte[] { 0x33 }, new byte[] { 0x34 },
																		   new byte[] { 0x34 }
		};
		#endregion
		...
		*/
		...
		#region Gear   (Name, Hex)
		// Hex representation in SpitfireGame.upk
		public static readonly Dictionary<string, byte[]> Gear = new Dictionary<string, byte[]>
		{
			//{ "_------------------------------------------------------", null },
			{ "--------------------- Damage-Gear ---------------------", new byte[] { 0xE3, 0xC4, 0x00, 0x00 } }, //Arcane Bubble Blower" to prevent crash
		//	{ "-_-----------------------------------------------------", null },
			{ "Arcane Bubble Blower", new byte[] { 0xE3, 0xC4, 0x00, 0x00 } },
			{ "Fire Wall Bracers", new byte[] { 0xE5, 0xC4, 0x00, 0x00 } },
		//  { "Flame Bracers", new byte[] { } },
			...
			//{ "--_----------------------------------------------------", null },
			{ "--------------------- Utility-Gear ---------------------", new byte[] { 0xE3, 0xC4, 0x00, 0x00 } }, //Arcane Bubble Blower" to prevent crash
			//{ "---_---------------------------------------------------", null },
			...
			//{ "----_--------------------------------------------------", null },
			{ "--------------------- ??????-???? ---------------------", new byte[] { 0xE3, 0xC4, 0x00, 0x00 } }, //Arcane Bubble Blower" to prevent crash
			//{ "-----_-------------------------------------------------", null },
		...
		#region  Guardians (Name (Hex String code, Length))
		// Hex string representation in SpitfireGame.upk
		public static readonly Dictionary<string, KeyValuePair<byte[], byte>> Guardians = new Dictionary<string, KeyValuePair<byte[], byte>>
		{
			{ "Bartender Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Blacksmith Guardian",new KeyValuePair<byte[], byte>
				(
			...
			{ "Cook Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Deckhand Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Dragon Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Friar Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Headhunter Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Jade Empire", new KeyValuePair<byte[], byte>
				(
			...
			{ "Jailer Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Lion Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Moon Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Priest Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Quartermaster Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Ranch Hand Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Rumrudder Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Serpent Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Stablehand Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "Sun Guardian", new KeyValuePair<byte[], byte>
				(
			...
			{ "WeaponWright Guardian", new KeyValuePair<byte[], byte>
				(
